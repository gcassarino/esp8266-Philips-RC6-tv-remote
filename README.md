...
Apart from the fact that I'm not an experienced C programmer, I have to admit that I really enjoyed myself porting the code from PHP to C and this new version is better than the one in PHP on the Raspberry!
