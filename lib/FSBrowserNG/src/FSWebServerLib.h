...
// GIANLUCA
// abilitando HIDE_CONFIG i files di configurazione non saranno
// accessibili tramite le chiamate al web server e non saranno editabili tramite
// l'editor integrato. NOTE se non protette le credenziali di rete sono visibili
